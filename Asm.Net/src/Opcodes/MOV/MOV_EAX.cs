...
{
    public class MOV_EAX : Instruction, IMov
    {
        public VirtualAddress ModifiyValue { get; set; }
        public MOV_EAX(VirtualAddress virtualAddress)
            : base(5, typeof(IMov))
        {
        ...
        {
            return new byte[] { (byte)OpcodeList.MOV_EAX,
        ...
        {
            registers.EAX = ModifiyValue.Address;
        }
        ...
        {
            return "MOV EAX, 0x" + ModifiyValue.Address.ToString("X6");
        }
    }
}