...
{
    public class MOV_EDX : Instruction, IMov
    {
        ...
        {
            return new byte[] { (byte)OpcodeList.MOV_EDX,
        ...
        public void Execute(Registers registers)
        {
            ...
            registers.EDX = ModifiyValue.Address;
        }
        ...
        {
            return "MOV EDX, 0x" + ModifiyValue.Address.ToString("X6");
        }
